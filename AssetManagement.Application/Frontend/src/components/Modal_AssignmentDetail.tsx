...
export default function AssignmentDetail(props:any) {
    ...
    useEffect(() => {
        ...
        const getData = async ()=>{
            await axiosInstance.get(`Assignment/${props.data}`)
                .then((res) => {
    ...
    return (
        <div> 
            ...
            <DialogContent className="dig-data">
                ...
                <div className="dig-data-data">
                    {statee.assignedState === 1 ? "Accepted" : (statee.assignedState === 2 ? "Waiting for acceptance" : "Declined")}
                </div>
            </DialogContent>
            <DialogContent className="dig-data">
                <div className="dig-data-label">
